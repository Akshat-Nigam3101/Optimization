function [bestsol,bestfitness,BestFitIter,P,f] = TLBO(prob,lb,ub,Np,T,B)
%% Starting of TLBO
...
for p = 1:Np
    [f(p),profit] = prob(P(p,:),ub,lb,B);            % Evaluating the fitness function of the initial population
end
...
for t = 1: T
    for i = 1:Np
        ...
        [fnew,profit] = prob(Xnew,ub,lb,B);          % Evaluating the fitness of the newly generated solution
