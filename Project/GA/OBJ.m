function [f,profit] = OBJ(x,ub,lb,B)
     ...
     [P,S,F,SC] = Data;                 % Accessing the data from the function
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % PR(1)= 0.5*(x(1)/TotalFineChef)+0.1*(x(2)/TotalFineChef)-0.2*(x(3)/TotalFineChef)+0.4*(x(7)/B)+0.2*(x(9)/B);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % PR(2)= -0.1*(x(1)/TotalFineChef)+0.3*(x(2)/TotalFineChef)+0.3*(x(3)/TotalFineChef)+0.3*(x(7)/B)+0.2*(x(9)/B);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % PR(3)= 0.2*(x(4)/TotalCasualChef)+0.2*(x(5)/TotalCasualChef)+0.1*(x(6)/TotalCasualChef)+0.2*(x(8)/B)+0.3*(x(10)/B);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % PR(4)= -0.1*(x(4)/TotalCasualChef)+0.2*(x(5)/TotalCasualChef)+0.3*(x(6)/TotalCasualChef)+0.2*(x(8)/B)+0.4*(x(10)/B);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % PR(1)= PR(1)*(0.7*x(7)/B)+0.3*(x(9)/B);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % PR(2)= PR(2)*(0.4*x(7)/B)+0.6*(x(9)/B);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % PR(3)= PR(3)*(0.4*x(8)/B)+0.6*(x(10)/B);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % PR(4)= PR(4)*(0.3*x(8)/B)+0.7*(x(10)/B);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % PR(1)= (x(1)/TotalFineChef)*(x(2)/TotalFineChef)*(x(3)/TotalFineChef)*(x(7)/B)*(x(9)/B);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % PR(2)= (x(1)/TotalFineChef)*(x(2)/TotalFineChef)*(x(3)/TotalFineChef)*(x(7)/B)*(x(9)/B);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % PR(3)= (x(4)/TotalCasualChef)*(x(5)/TotalCasualChef)*(x(6)/TotalCasualChef)*(x(8)/B)*(x(10)/B);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % PR(4)= (x(4)/TotalCasualChef)*(x(5)/TotalCasualChef)*(x(6)/TotalCasualChef)*(x(8)/B)*(x(10)/B);
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     % 
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     % penalty_Chef = 0;
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     % if  20*FineChef < P(1)*PR(1)                         % Checking for violation of the investment cost constraint
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     %     penalty_Chef = (100*(TotalEmp - EmpCap))^2;       % Determining the penalty due to violation for investment cost
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     % end
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     %
